// All content lifted verbatim from the source doc, structured for rendering.
window.FRAMEWORK = {
  title: "The AI-Powered Development Framework",
  subtitle: "A Repeatable Workflow for Building Production-Grade, Globally Deployable Web Applications",
  version: "v1.0 — May 2026",
  tagline: "Built for production. Designed to scale. Security-first by default.",
  ...
  stages: [
    {
      ...
      glyph: "✦",
      color: "butter",
      who: "User + any capable AI (Claude.ai, ChatGPT, etc.)",
      whatHappens:
      ...
      produceLabel: "What you produce:",
      produceIntro: "A written Idea Document that covers:",
      produceList: [
        "What the app does",
        "Who it is for",
      ...
      checkpoint:
        "Read the Idea Document. Does it accurately describe what you want to build? Edit it until it does. Do not move to Stage 2 until you would be comfortable handing this to a developer and having them understand the project."
    },
    {
      n: 2,
      ...
      glyph: "◐",
      color: "sage",
      who: "User + Claude Opus 4.7 in Plan Mode (Claude Code CLI)",
      whatHappens:
      ...
      checkpointIntro:
        "Open the plan file (Ctrl+G to open it in your editor). Read every section. Ask yourself:",
      checkpointList: [
    ...
    },
    {
      ...
      glyph: "▲",
      color: "peach",
      who: "User + GPT-5.5 (via Codex, API, GitHub Copilot, or any interface the user prefers)",
      whatHappens:
      ...
      checkpointLabel: "Human checkpoint at each task:",
      checkpoint:
        "As each section is built, the user reviews the output before moving to the next task in the plan. If GPT-5.5 deviates from the plan, it must explain why before proceeding."
    },
    {
      n: 4,
      ...
      glyph: "◆",
      color: "lilac",
      who: "User + Claude Opus 4.7 + Claude Security",
      whatHappens:
      ...
      produceLabel: "What you check against:",
      produceIntro: "The full security checklist in this document.",
      checkpoint:
        "Review every flagged issue from both Claude Opus and Claude Security. No item on the security checklist should be marked unresolved before going to Stage 5."
    },
    {
      n: 5,
      title: "Deployment",
      ...
      checkpoint: "Preview deployment works as expected before promoting to production."
    }
  ],
  ...
  security: {
    ...
    owasp: {
      ...
      intro: "Before deployment, verify the application is not vulnerable to:",
      items: [
  ...
  privacy: {
    ...
    gdpr: {
      ...
      lede: "Applies to any app with EU users, regardless of where your company is based. Even one European user triggers full GDPR obligations.",
    ...
    practical: {
      title: "The Practical Approach for Global Apps",
      body:
      ...
      docsLabel: "Minimum required documents before launch:",
      docs: [
  ...
  stack: [
    {
      ...
      alt: "Remix (better progressive enhancement, more explicit data loading model — good choice if you prioritize web fundamentals over Vercel-specific features)"
    },
    {
      name: "Language",
      pick: "TypeScript",
      ...
      alt: "None recommended for production."
    },
    {
      name: "Deployment",
      pick: "Vercel",
      ...
      cost: "Vercel's free tier works for development. The Pro plan ($20/month per user) is required for production apps with teams. As your app scales, evaluate Railway (usage-based pricing, better for high-traffic apps) or Cloudflare Pages (best global edge performance, generous free tier).",
      alts: [
    ...
    },
    {
      ...
      switchLabel: "When to switch to Neon + Clerk instead:",
      switch: [
      ...
      alt: "Clerk pairs with any database and is the best dedicated auth solution for Next.js. More polished UI components, stronger enterprise features (SSO, organizations, RBAC). Worth the added cost for B2B apps."
    },
    {
      name: "ORM",
      pick: "Prisma",
      ...
      alt: "Drizzle ORM — lighter, faster, more SQL-like syntax. Good choice if you're comfortable writing SQL and want maximum performance."
    },
    {
      name: "Styling",
      pick: "Tailwind CSS",
      ...
      ui: "shadcn/ui — accessible, unstyled-by-default components you own in your codebase. Not a dependency, not a lock-in."
    },
    {
      name: "AI Integration",
      pick: "Vercel AI SDK",
      ...
      keys: "User-supplied LLM API keys must be encrypted at rest and decrypted only in server-side route handlers. Never pass user API keys to the client. Never log them."
    }
  ],
  ...
  mistakes: [
    {
      t: "Skipping the plan and going straight to code.",
      b: "Without an approved architecture, the execution model improvises. You get fast code that solves the wrong problem or builds the wrong structure."
    },
    {
      t: "Treating security as a final step.",
      b: "Security is baked into Stage 2 (the plan includes it) and Stage 4 (it is reviewed before deployment). It is not an afterthought."
    },
    {
      t: "Storing secrets wrong.",
      b: "API keys and secrets belong in environment variables. This is specified in the plan stage and enforced in the security review."
    },
    {
      t: "Letting the AI deviate from the plan silently.",
      b: "Stage 3 requires the user to review each task. If GPT-5.5 changes the approach without explanation, that is a checkpoint failure, not a feature."
    },
    {
      t: "Deploying without a security review.",
      b: "Stage 4 exists because AI-generated code frequently contains security gaps. The security review is not optional."
    }
  ],

  starting: [
    "Open Claude.ai (or any capable AI) and describe your idea",
    "Iterate until you have an approved Idea Document",
    "Open Claude Code, select Opus 4.7, enter Plan Mode (/plan or Shift+Tab twice)",
    "Send the Idea Document and ask Opus to produce an architectural plan",
    "Review the plan, edit as needed, approve it",
    "Open GPT-5.5 (Codex, API, GitHub Copilot, or your preferred interface)",
    "Send the approved plan and build task by task",
    "Return to Claude Opus for security review",
    "Deploy to Vercel from your approved, reviewed codebase"
  ],
  ...
  solo: {
    title: "A Note for Solo Developers",
    intro:
    ...
    points: [
      {
        t: "You are still a data controller under GDPR.",
        b: "The law does not have a solo developer exemption. The moment a user in the EU creates an account on your app, you have legal obligations around their data. Company size is irrelevant. What matters is whose data you are processing and where they are from."
      },
      {
        t: "You are not held to an enterprise operational standard.",
        b: "Regulators pursue bad actors and negligence. A solo developer who made a genuine, documented effort to handle user data responsibly is in a fundamentally different position from a company that ignored the rules entirely. Building with this framework is that documented effort."
      }
    ],
    skipLabel: "What solo developers most commonly skip — and shouldn't:",
    skip: [
    ...
    scaleLabel: "What realistically scales with size:",
    scale: [
